    ...
    <main class="container">
        ...
        <form method="post" action="/produtos/editar">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="valor" name="valor" value="<?= $resultado["valor"] ?>" required>
            </div>
            <div class="form-group">
                <label for="categoria_id">Categoria ID</label>
                <input type="number" class="form-control" id="categoria_id" name="categoria_id" value="<?= $resultado["categoria_id"] ?>" required>
            </div>
            <br>
